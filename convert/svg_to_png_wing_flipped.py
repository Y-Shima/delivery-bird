#!/usr/bin/env python3
"""
翼上下反転版の64x64サイズのSVGファイルをPNGに変換するスクリプト
"""
...
def convert_wing_flipped_sprites():
    """翼上下反転版スプライト専用の変換"""
    ...
    # 翼上下反転版スプライトファイルのリスト
    sprite_files = [
        ("meimei-wing-flipped-64.svg", "meimei.png"),
        ("meimei-fly1-wing-flipped-64.svg", "meimei-fly1.png"), 
        ("meimei-fly2-wing-flipped-64.svg", "meimei-fly2.png"),
        ("meimei-powerup-wing-flipped-64.svg", "meimei-powerup.png"),
        ("meimei-stunned-wing-flipped-64.svg", "meimei-stunned.png"),
        ("enemy-blue-wing-flipped-64.svg", "enemy-blue.png"),
        ("enemy-red-wing-flipped-64.svg", "enemy-red.png"),
        ("enemy-yellow-wing-flipped-64.svg", "enemy-yellow.png")
    ]
    
    print("🎨 翼上下反転版 64x64 SVG to PNG 変換開始...")
    ...
    # favicon作成（メイメイから）
    favicon_svg = svg_dir / "meimei-wing-flipped-64.svg"
