#!/usr/bin/env python3
"""
修正版の64x64サイズのSVGファイルをPNGに変換するスクリプト
"""
...
def convert_fixed_sprites():
    ...
    # 修正版スプライトファイルのリスト
    sprite_files = [
        ("meimei-fixed-64.svg", "meimei.png"),
        ("meimei-fly1-fixed-64.svg", "meimei-fly1.png"), 
        ("meimei-fly2-fixed-64.svg", "meimei-fly2.png"),
        ("meimei-powerup-fixed-64.svg", "meimei-powerup.png"),
        ("meimei-stunned-fixed-64.svg", "meimei-stunned.png"),
        ("enemy-blue-fixed-64.svg", "enemy-blue.png"),
        ("enemy-red-fixed-64.svg", "enemy-red.png"),
        ("enemy-yellow-fixed-64.svg", "enemy-yellow.png")
    ]
    
    print("🎨 修正版 64x64 SVG to PNG 変換開始...")
    ...
    # favicon作成（メイメイから）
    favicon_svg = svg_dir / "meimei-fixed-64.svg"
